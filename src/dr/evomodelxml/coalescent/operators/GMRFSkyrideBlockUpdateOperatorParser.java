...
import beast.evolution.operators.GMRFMultilocusSkyrideBlockUpdateOperator;
import beast.evolution.operators.GMRFSkyrideBlockUpdateOperator;
...
//                throw new XMLParseException("scaleFactor must be greater than 0.0");
        ...
        if (xo.getAttribute(OLD_SKYRIDE, true)
            ...
            GMRFSkyrideBlockUpdateOperator operator = new GMRFSkyrideBlockUpdateOperator();
            operator.initByName("likelihood", gmrfLikelihood, "weight", weight, "scaleFactor", scaleFactor,
            		"maxIterations", maxIterations, "stopValue", stopValue,
            		"optimise", mode == CoercionMode.COERCION_OFF ? false : true);
            return operator;
        } else {
            ...
            GMRFMultilocusSkyrideBlockUpdateOperator operator = new GMRFMultilocusSkyrideBlockUpdateOperator();
            operator.initByName("likelihood", gmrfMultilocusLikelihood, "weight", weight, "scaleFactor", scaleFactor,
            		"maxIterations", maxIterations, "stopValue", stopValue,
            		"optimise", mode == CoercionMode.COERCION_OFF ? false : true);
            return operator;
        }
