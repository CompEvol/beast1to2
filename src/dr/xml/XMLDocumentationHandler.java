...
public class XMLDocumentationHandler {
    ...
    public void outputElements(PrintWriter writer) {
        ...
        writer.println("<html>");
        printDocXMLTitle(writer, "detail.html");//BeastParserDoc.DETAIL_HTML);
        writer.println("<p>");
...
//            final Class returnType = xmlParser.getReturnType();
    ...
    public void outputIndex(PrintWriter writer) {
        ...
        writer.println("<html>");
        printDocXMLTitle(writer, "index.html");//BeastParserDoc.INDEX_HTML);
        writer.println("<p>");
...
//                            writer.println("  <div class=\"elementheader\">");
                            writer.println("    <span class=\"elementname\"><a href=\"" + "detail.html" /*BeastParserDoc.DETAIL_HTML*/
...
//        return "<A HREF=\"" + BeastParserDoc.DEATAIL_HTML + "#" + name + "\">" + name + "</A>";
        return "<A HREF=\"" + "index.html" /*BeastParserDoc.INDEX_HTML*/ + "#" + name + "\">" + name + "</A>";
    }
/*
	class SetHash {
